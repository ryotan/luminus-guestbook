...
Two middleware functions are provided by default in the `luminus-guestbook.middleware` namespace.
...
See the `:middleware` key of the `app` definition located in the `luminus-guestbook.handler` namespace to manage the enabled middleware.
